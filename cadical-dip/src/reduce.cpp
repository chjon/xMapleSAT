...
void Internal::reduce () {
  ...
  //cout << "REDUCE " << stats.reductions << endl;
  // if (max_var >= 697) {
  //   vector<Clause*> res = find_definition_clauses(697);
  //   if (res.size() == 0) cout << "Not founde before reduce" << endl;
  //   else cout << "Found before reduce" << endl;
  // }
  // if (stats.reductions == 96) {
  //   for (auto cl :  clauses) {
  //     for (auto l : *cl) cout << l << " ";
  //     cout << cl << " deleted " << cl->garbage << endl;
  //   }
  //   exit(1);
  // }
  stats.reductions++;
...
DONE:
  ...
  //   if (max_var >= 697) {
  //   vector<Clause*> res = find_definition_clauses(697);
  //   if (res.size() == 0) cout << "Not founde after reduce" << endl;
  //   else cout << "Found after reduce" << endl;
  // }
