    ...
    if (tmp) { // literal already assigned
      ...
      if (tmp > 0) { // positively implied
        ...
        if (redundant_mode) {
          ...
          //
          vivify_analyze_redundant (vivifier, v.reason,
                                    only_binary_reasons);
          if (!only_binary_reasons) {
...
void Internal::vivify () {
  ...
  //   if (tmp == NULL)
  //     cout << "Clause not found at the beginning of vivify" << endl; 
  //   else cout << "Found at the beginning of vivify (garbage " << tmp->garbage << ")" << endl;
  // }
  ...
  //   Clause* tmp = find_binary_extended_clause_in_DB(493,209);	
  //   if (tmp == NULL)
  //     cout << "Clause not found at the end of vivify" << endl; 
  //   else cout << "Found at the end of vivify (garbage " << tmp->garbage << ")" << endl;
  // }
