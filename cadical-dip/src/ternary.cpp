...
bool Internal::ternary () {
  ...
  //   if (tmp == NULL)
  //     cout << "Clause not found at the beginning of ternary" << endl; 
  //   else cout << "Found at the beginning of ternary (garbage " << tmp->garbage << ")" << endl;
  // }
  ...
  //   Clause* tmp = find_binary_extended_clause_in_DB(493,209);	
  //   if (tmp == NULL)
  //     cout << "Clause not found at the end of ternary" << endl; 
  //   else cout << "Found at the end of ternary (garbage " << tmp->garbage << ")" << endl;
  // }
